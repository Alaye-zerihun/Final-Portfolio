      ...
      <div className="contact__wrapper">
        ...
        >
          <div className="contact__wrapper__form-container">
            <h3 className="contact__wrapper__form-container__header-text">
              Let's Talk
            </h3>
        ...
        <div className="contact__text-container">
          <div className="contact__text">
            ...
            <p>
              <FaUsers className="cooperation-icon" /> Let's work together to
              create something impactful and beneficial for our users and
              community. Reach out today, and let's start building together!
            </p>
          </div>
          <div className="contact__image">
            <img src={image} alt="Alexcontact" />
          </div>
        </div>
      </div>
    </section>
